...
class TNZAPI():
    ...
    def Messaging(self, **kwargs):
        ...
        if self._messaging == None:
            from tnzapi.api.v204.messaging.requests import Messaging
    ...
    def Reports(self, **kwargs):
        ...
        if self._reports == None:
            from tnzapi.api.v204.reports.requests import Reports
    ...
    def Actions(self, **kwargs):
        ...
        if self._actions == None:
            from tnzapi.api.v204.actions.requests import Actions
    ...
    def Addressbook(self, **kwargs):
        ...
        if self._addressbook == None:
            from tnzapi.api.v204.addressbook import Addressbook
