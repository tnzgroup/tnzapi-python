...
from tnzapi.api.v204.messaging.dtos.sms_api_request_dto import SMSApiRequestDTO
from tnzapi.api.v204.messaging.requests._common import Common
from tnzapi.api.v204.messaging.responses import MessageApiResult
...
class SMSApi(Common):
    ...
    @property
    def MessageText(self): return self.APIMessageData.Message

    @MessageText.setter
    def MessageText(self,val): self.APIMessageData.Message = val
