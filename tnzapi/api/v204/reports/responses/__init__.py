...
def StatusRequestResult(**kwargs):
    ...
    from tnzapi.api.v204.reports.responses.status_request_result import StatusRequestResult as run
...
def SMSReplyResult(**kwargs):
    ...
    from tnzapi.api.v204.reports.responses.sms_reply_result import SMSReplyResult as run
...
def SMSReceivedResult(**kwargs):
    ...
    from tnzapi.api.v204.reports.responses.sms_received_result import SMSReceivedResult as run
